...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws ParseException {
        ...
        Item insulated1 = new Insulated("Vest", "Northface", null, null, user2, "M", InsulationType.SYNTHETIC, clothing);
        itemRepository.save(insulated1);

        Booking booking2 = new Booking("12/12/2022", "24/12/2022", user1, insulated1);
        bookingRepository.save(booking2);

        Item waterproof1 = new Waterproof("Jacket", "Patagonia", null, null, user3, "L", WaterproofRatingType.OVER_10000_MM, clothing);
        ...
        Item stove1 = new Stove("gassy", "sprakies", null, null, user2, 100, 100, FuelType.GAS, false, cooking);
        itemRepository.save(stove1);

        Booking booking5 = new Booking("12/04/2023", "17/04/2023", user1, stove1);
        bookingRepository.save(booking5);

        Item lighting1 = new Lighting("super bright", "maglite", null, null, user1, true, 1000, LightingType.TORCH, electronic);
        ...
        Item offRoad1 = new OffRoad("rough rider", "squeaky clean", null, null, user1, "L", SuspensionType.FULL_SUSPENSION, bike);
        itemRepository.save(offRoad1);

        Booking booking9 = new Booking("12/03/2023", "16/03/2023", user2, offRoad1);
        bookingRepository.save(booking9);

        Item road1 = new Road("super fast", "boardman", null, null, user2, "M", BrakeType.DISC_BRAKES, bike);
        ...
        Item sleepingBag1 = new SleepingBag("bag", "snuggle", null, null, user1, 2000, InsulationType.DOWN, 16, SeasonType.FOUR_SEASON, "5x10x13", camping);
        ...
        Item sleepingmat1 = new SleepingMat("Matt", "Flats", null, null, user1, 1000, 10, "5x5x5", SeasonType.ONE_SEASON, camping);
        ...
        Item bag1 = new Bag("bag", "baggiltons", null, null, user1, BagLocationType.TOP_TUBE, 10, bag);

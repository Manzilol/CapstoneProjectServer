...
public class BivvyBag extends Camping {
    ...
    public BivvyBag(String name, String brand, List<Integer> ratings, List<String> comments, User user, int weight, String packSize, boolean hooped, Category category, SubCategory subCategory) {

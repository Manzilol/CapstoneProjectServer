...
public class Waterproof extends Clothing {
    ...
    public Waterproof(String name, String brand, List<Integer> ratings, List<String> comments, User user, String size, WaterproofRatingType waterproofRating, Category category) {
